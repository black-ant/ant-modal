...
class MistralChat:
    ...
    def load_model(self):
        ...
        # Mistral-7B-Instruct 或 Mixtral-8x7B-Instruct
...
def main(prompt: str = "What is the meaning of life?"):
    mistral = MistralChat()
    
    messages = [{"role": "user", "content": prompt}]
    
    response = mistral.chat.remote(messages=messages)
    print(f"\n🤖 Mistral: {response}\n")
